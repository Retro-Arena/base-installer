...
sudo __nodialog=1 ./retroarena_packages.sh retroarch install_bin
...
sudo __nodialog=1 ./retroarena_packages.sh emulationstation install_bin
...
sudo __nodialog=1 ./retroarena_packages.sh lr-mupen64plus depends
...
#sudo __nodialog=1 ./retroarena_packages.sh kodi configure
...
# cleanup
sudo rm -rf /root/rp64_build_bin.sh
sudo rm -rf /root/rp64_packages.txt
sudo rm -rf /home/pigaming/rp64_build_bin.sh
