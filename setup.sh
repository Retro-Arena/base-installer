...
function post_update_setup() {
    ...
    printMsgs "dialog" "ATTENTION:\nThis is a BETA build with the intention to allow for pre Public Release trials and feedback. Due to the nature of the fact that this is a closed Beta it does not have the ability to be updated.\n\nWe will not be technically supporting this Beta from a troubleshooting perspective however constructive feedback would be appreciated via our Github issues tracker at https://github.com/Retro-Arena/RetroArena-Setup/issues\n\nPlease be sure to let us know that you are submitting for the beta.\n\nThank you and we hope you enjoy the Preview!\n\nNo copyrighted gamees are included with RetroArena.\n\nIf you have been sold this software, you can let us know about it by emailing therealretroarena@outlook.com"
